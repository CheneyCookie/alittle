...
<body>
	...
	<br><br>
	<form action="testHttpMessageConvertor" method="post" enctype="multipart/form-data">
		File:<input type="file" name="file">
		Desc<input type="text" name="desc">
		<input type="submit" value="submit">
	</form>
	...
	<!-- 关于国际化
	 ...
	 <br><br>
	 <a href="testResourceStatusExceptionResolver?i=10">Test ResourceStatusExceptionResolver</a>
	 <br><br>
	 <a href="testSimpleMappingExceptionResolver?i=2">Test ResourceStatusExceptionResolver</a>
	 <br><br>
</body>
</html>